...
$rootScope.App.ID = "com.appbuilder.pushplugin";
$rootScope.App.Name = "PushPlugin (Created with an unregistered version of App Builder)";
...
$rootScope.HttpClient.Request.url = "";
$rootScope.HttpClient.Request.method = "POST";
$rootScope.HttpClient.Transform = "data";

$rootScope.ResponseTextarea = {};
$rootScope.ResponseTextarea.ABRole = 9001;
$rootScope.ResponseTextarea.Hidden = "";
$rootScope.ResponseTextarea.Value = "";
$rootScope.ResponseTextarea.Title = "";
$rootScope.ResponseTextarea.TabIndex = -1;
$rootScope.ResponseTextarea.TooltipText = "";
$rootScope.ResponseTextarea.TooltipPos = "top";
$rootScope.ResponseTextarea.PopoverText = "";
$rootScope.ResponseTextarea.PopoverEvent = "mouseenter";
$rootScope.ResponseTextarea.PopoverTitle = "";
$rootScope.ResponseTextarea.PopoverPos = "top";
$rootScope.ResponseTextarea.PlaceHolder = "";
$rootScope.ResponseTextarea.Class = "form-control input-sm ";
$rootScope.ResponseTextarea.Disabled = "";
$rootScope.ResponseTextarea.Required = "";
$rootScope.ResponseTextarea.ReadOnly = "true";

$rootScope.ResponseLabel = {};
$rootScope.ResponseLabel.ABRole = 6002;
$rootScope.ResponseLabel.Hidden = "";
$rootScope.ResponseLabel.Class = "";
$rootScope.ResponseLabel.Text = "Server response";
$rootScope.ResponseLabel.Input = "ResponseTextarea";
$rootScope.ResponseLabel.Title = "";
$rootScope.ResponseLabel.TooltipText = "";
$rootScope.ResponseLabel.TooltipPos = "top";
$rootScope.ResponseLabel.PopoverText = "";
$rootScope.ResponseLabel.PopoverEvent = "mouseenter";
$rootScope.ResponseLabel.PopoverTitle = "";
$rootScope.ResponseLabel.PopoverPos = "top";
$rootScope.ResponseLabel.Icon = "";
...
$rootScope.RequestButton.Text = "Request a push notification";
$rootScope.RequestButton.Class = "btn btn-primary btn-xs ";
...
$scope.SendRegisterID = function(TheRegisterID)
{

$rootScope.HttpClient.Request.method = "POST";

$rootScope.HttpClient.Request.url = "http://www.davidesperalta.com/Humm/Sites/Main/Views/Data/AppBuilder/Samples/PushPlugin/register.php";

$rootScope.HttpClient.Request.data["RegisterID"] = TheRegisterID;
...
alert('This app sample need to be compiled first with Cordova in order to run.');
return null;
}
window.push = PushNotification.init({
"android": {"senderID": "653968308986"}
});
window.push.on('registration', function(data) {
window.App.Scope.SendRegisterID(data.registrationId);
});
window.push.on('notification', function(data) {
alert(data.message);
});
window.push.on('error', function(error) {
...
$rootScope.HttpClient.Execute = function() {
  ...
  } else if ($rootScope.HttpClient.Transform == "form") {
    $rootScope.HttpClient.Request.transformRequest = function(data) { var frmData = []; angular.forEach(data, function(value, key) { frmData.push(encodeURIComponent(key) + "=" + encodeURIComponent(value)); }); return frmData.join("&"); };
...
$rootScope.ResponseTextarea.Value = $rootScope.HttpClient.Response;
...
$scope.alertBox("Registration ID send fail: "+$rootScope.HttpClient.Response+"", "danger");
...
$rootScope.HttpClient.Request.method = "GET";

$rootScope.HttpClient.Request.url = "https://www.davidesperalta.com/Humm/Sites/Main/Views/Data/AppBuilder/Samples/PushPlugin/sendpush.php?message=A new push notification by the app!";
