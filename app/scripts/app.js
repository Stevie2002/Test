...
$rootScope.App.ID = "com.appbuilder.pusher";
$rootScope.App.Name = "Pusher (Created with an unregistered version of App Builder)";
...
$rootScope.ConnectButton = {};
$rootScope.ConnectButton.ABRole = 2001;
$rootScope.ConnectButton.Hidden = "";
$rootScope.ConnectButton.Title = "";
$rootScope.ConnectButton.TabIndex = -1;
$rootScope.ConnectButton.TooltipText = "";
$rootScope.ConnectButton.TooltipPos = "top";
$rootScope.ConnectButton.PopoverText = "";
$rootScope.ConnectButton.PopoverTitle = "";
$rootScope.ConnectButton.PopoverEvent = "mouseenter";
$rootScope.ConnectButton.PopoverPos = "top";
$rootScope.ConnectButton.Badge = "";
$rootScope.ConnectButton.Icon = "";
$rootScope.ConnectButton.Text = "Connect";
$rootScope.ConnectButton.Class = "btn btn-info btn-xs ";
$rootScope.ConnectButton.Disabled = "";

$rootScope.Pusher1 = {};
$rootScope.Pusher1.ABRole = 30009;
$rootScope.Pusher1.AppKey = "aeb2dedcb0a74f311ee7";
$rootScope.Pusher1.Event = "MyEvent";
$rootScope.Pusher1.Channel = "MyChannel";

$rootScope.HttpClient1 = {};
$rootScope.HttpClient1.ABRole = 30001;
$rootScope.HttpClient1.Status = 0;
$rootScope.HttpClient1.StatusText = "";
$rootScope.HttpClient1.Response = "";
$rootScope.HttpClient1.Request = {};
$rootScope.HttpClient1.Request.data = {};
$rootScope.HttpClient1.Request.headers = {};
$rootScope.HttpClient1.Request.url = "https://www.davidesperalta.com/Humm/Sites/Main/Views/Data/AppBuilder/Samples/Pusher/Trigger.php";
$rootScope.HttpClient1.Request.method = "GET";
$rootScope.HttpClient1.Transform = "data";

$rootScope.EventsLabel = {};
$rootScope.EventsLabel.ABRole = 6002;
$rootScope.EventsLabel.Hidden = "";
$rootScope.EventsLabel.Class = "";
$rootScope.EventsLabel.Text = "Events";
$rootScope.EventsLabel.Input = "EventsTextarea";
$rootScope.EventsLabel.Title = "";
$rootScope.EventsLabel.TooltipText = "";
$rootScope.EventsLabel.TooltipPos = "top";
$rootScope.EventsLabel.PopoverText = "";
$rootScope.EventsLabel.PopoverEvent = "mouseenter";
$rootScope.EventsLabel.PopoverTitle = "";
$rootScope.EventsLabel.PopoverPos = "top";
$rootScope.EventsLabel.Icon = "";
...
$rootScope.EventsTextarea.Class = "form-control input-sm ";
$rootScope.EventsTextarea.Disabled = "";
$rootScope.EventsTextarea.Required = "";
$rootScope.EventsTextarea.ReadOnly = "true";

$rootScope.RequestButton = {};
$rootScope.RequestButton.ABRole = 2001;
$rootScope.RequestButton.Hidden = "";
$rootScope.RequestButton.Title = "";
$rootScope.RequestButton.TabIndex = -1;
$rootScope.RequestButton.TooltipText = "";
$rootScope.RequestButton.TooltipPos = "top";
$rootScope.RequestButton.PopoverText = "";
$rootScope.RequestButton.PopoverTitle = "";
$rootScope.RequestButton.PopoverEvent = "mouseenter";
$rootScope.RequestButton.PopoverPos = "top";
$rootScope.RequestButton.Badge = "";
$rootScope.RequestButton.Icon = "";
$rootScope.RequestButton.Text = "Request push";
$rootScope.RequestButton.Class = "btn btn-success btn-xs ";
$rootScope.RequestButton.Disabled = "true";

$rootScope.DisconnectButton = {};
$rootScope.DisconnectButton.ABRole = 2001;
$rootScope.DisconnectButton.Hidden = "";
$rootScope.DisconnectButton.Title = "";
$rootScope.DisconnectButton.TabIndex = -1;
$rootScope.DisconnectButton.TooltipText = "";
$rootScope.DisconnectButton.TooltipPos = "top";
$rootScope.DisconnectButton.PopoverText = "";
$rootScope.DisconnectButton.PopoverTitle = "";
$rootScope.DisconnectButton.PopoverEvent = "mouseenter";
$rootScope.DisconnectButton.PopoverPos = "top";
$rootScope.DisconnectButton.Badge = "";
$rootScope.DisconnectButton.Icon = "";
$rootScope.DisconnectButton.Text = "Disconnect";
$rootScope.DisconnectButton.Class = "btn btn-danger btn-xs ";
$rootScope.DisconnectButton.Disabled = "true";

$rootScope.ProgressSpinner = {};
$rootScope.ProgressSpinner.ABRole = 6001;
$rootScope.ProgressSpinner.Hidden = "true";
$rootScope.ProgressSpinner.Class = "ios-inertial-scroll ";
$rootScope.ProgressSpinner.Title = "";
$rootScope.ProgressSpinner.TooltipText = "";
$rootScope.ProgressSpinner.TooltipPos = "top";
$rootScope.ProgressSpinner.PopoverText = "";
$rootScope.ProgressSpinner.PopoverEvent = "mouseenter";
$rootScope.ProgressSpinner.PopoverTitle = "";
$rootScope.ProgressSpinner.PopoverPos = "top";
    };
...
window.App.Ctrls.controller("NewView1Ctrl", ["$scope", "$rootScope", "$sce", "$interval", "$http", "$uibPosition", "blockUI",
...
angular.element(window.document).ready(function(event){
$rootScope.NewView1.Event = event;

$rootScope.$apply();
});

$scope.ConnectButtonClick = function($event) {
$rootScope.ConnectButton.Event = $event;

$rootScope.ProgressSpinner.Hidden = "";

$rootScope.ConnectButton.Disabled = "true";

$rootScope.Pusher1.Connect();

};

$rootScope.Pusher1.Connect = function() {
  $rootScope.Pusher1.Pusher = new Pusher($rootScope.Pusher1.AppKey, {encrypted: true});

  $rootScope.Pusher1.Pusher.connection.bind("error", function(error) {
    $rootScope.Pusher1.ErrorCode = error.error.data.code;
    $rootScope.Pusher1.ErrorText = error.error.data.message;
...
$scope.alertBox("Pusher error: "+$rootScope.Pusher1.ErrorText+"", "danger");

  });

  $rootScope.Pusher1.Pusher.connection.bind("state_change", function(state) {
    $rootScope.Pusher1.CurrentState = state.current;
    $rootScope.Pusher1.PreviousState = state.previous;

if (""+$rootScope.Pusher1.CurrentState+"" ==  "connected" ) {

$rootScope.ProgressSpinner.Hidden = "true";

$rootScope.RequestButton.Disabled = "";

$rootScope.DisconnectButton.Disabled = "";

} else if (""+$rootScope.Pusher1.CurrentState+"" ==  "disconnected" ) {
...
if ($rootScope.EventsTextarea.Value == "") {

$rootScope.EventsTextarea.Value = "Previous state: "+$rootScope.Pusher1.PreviousState+"\nCurrent state: "+$rootScope.Pusher1.CurrentState+"";

} else {

$rootScope.EventsTextarea.Value = ""+$rootScope.EventsTextarea.Value+"\nPrevious state: "+$rootScope.Pusher1.PreviousState+"\nCurrent state: "+$rootScope.Pusher1.CurrentState+"";

}

    if (state.current !== "disconnected") {$rootScope.$apply();}
  });

  $rootScope.Pusher1.ChannelHandle = $rootScope.Pusher1.Pusher.subscribe($rootScope.Pusher1.Channel);

  $rootScope.Pusher1.ChannelHandle.bind($rootScope.Pusher1.Event, function(data) {
    $rootScope.Pusher1.Message = data;

$rootScope.RequestButton.Disabled = "";

$rootScope.EventsTextarea.Value = ""+$rootScope.EventsTextarea.Value+"\nPush: "+$rootScope.Pusher1.Message+"";

$rootScope.$apply();
  });
};

$rootScope.Pusher1.Disconnect = function() {
  if($rootScope.Pusher1.Pusher){$rootScope.Pusher1.Pusher.disconnect();}
};

$rootScope.HttpClient1.Execute = function() {
  if ($rootScope.HttpClient1.Transform == "json") {
    $rootScope.HttpClient1.Request.transformRequest = function(data) {return JSON.stringify(data)};
  } else if ($rootScope.HttpClient1.Transform == "form") {
    $rootScope.HttpClient1.Request.transformRequest = function(data) { var frmData = []; angular.forEach(data, function(value, key) { frmData.push(encodeURIComponent(key) + "=" + encodeURIComponent(value)); }); return frmData.join("&"); };
  } else if ($rootScope.HttpClient1.Transform == "data") {
    $rootScope.HttpClient1.Request.transformRequest = function(data) {var frmData = new FormData(); angular.forEach(data, function(value, key) { frmData.append(key, value); }); return frmData;};
  }
  $http($rootScope.HttpClient1.Request)
  .then(function(response) {
    $rootScope.HttpClient1.Status = response.status;
    $rootScope.HttpClient1.Response = response.data;
    $rootScope.HttpClient1.StatusText = response.statusText;
...
$scope.alertBox("HTTP client error: "+$rootScope.HttpClient1.Response+"", "danger");

  });
};

$scope.RequestButtonClick = function($event) {
$rootScope.RequestButton.Event = $event;
...
$scope.DisconnectButtonClick = function($event) {
$rootScope.DisconnectButton.Event = $event;
